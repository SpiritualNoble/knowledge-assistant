            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
                ...
                <p className="text-base text-gray-700 mb-4">
                  智能知识助手是一个基于RAG (Retrieval Augmented Generation) 技术的知识检索增强系统，通过智能检索为用户提供精准的知识支持，提升工作效率。
                </p>
                <p className="text-base text-gray-700 mb-4">
                ...
                <p className="text-base text-gray-700 mt-2">
                  Email: <a href="mailto:contact@example.com" className="text-indigo-600 hover:text-indigo-500">contact@example.com</a>
                </p>
                <p className="text-base text-gray-700 mt-2">
                  GitHub: <a href="https://github.com/SpiritualNoble/knowledge-assistant" className="text-indigo-600 hover:text-indigo-500" target="_blank" rel="noopener noreferrer">github.com/SpiritualNoble/knowledge-assistant</a>
                </p>
              </div>
            </div>
          </div>
